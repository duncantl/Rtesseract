...
the OCR. Hence, the results of the image processing can be handed directly to the OCR engine for recognition, without the need to write intermediate files. 
