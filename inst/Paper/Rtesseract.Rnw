...
Then we reduce the recognization rectangle to only this area, with the dimensions specified as left edge, top edge, width of box, height of box,
...
coin), etc. Included in the available options are to have Tesseract
