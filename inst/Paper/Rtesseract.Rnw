...
1994. It was entered into 1995 UNLV Annual Test of OCR Accuracy, where
...
for Open Source in 2005. It has since been maintained by Google
(accuracy?) and open-source developers.
...
bb[i,]
m = plot(ts, cropToBoxes = TRUE)
rect(m[i,"left"],m[i,"bottom"],m[i,"right"],m[i,"top"], col = "red")
