...
if( tesseractVersion(runTime = FALSE ) %in% c('3.0', "3.05", "3.05.01")) {
...
OrientationValues = structure(c(0L, 1L, 2L, 3L), .Names = c('ORIENTATION_PAGE_UP', 'ORIENTATION_PAGE_RIGHT', 'ORIENTATION_PAGE_DOWN', 'ORIENTATION_PAGE_LEFT'))
...
WritingDirectionValues = structure(c(0L, 1L, 2L), .Names = c('WRITING_DIRECTION_LEFT_TO_RIGHT', 'WRITING_DIRECTION_RIGHT_TO_LEFT', 'WRITING_DIRECTION_TOP_TO_BOTTOM'))
...
TextlineOrderValues = structure(c(0L, 1L, 2L), .Names = c('TEXTLINE_ORDER_LEFT_TO_RIGHT', 'TEXTLINE_ORDER_RIGHT_TO_LEFT', 'TEXTLINE_ORDER_TOP_TO_BOTTOM'))
...
PageIteratorLevelValues = structure(c(0L, 1L, 2L, 3L, 4L), .Names = c('RIL_BLOCK', 'RIL_PARA', 'RIL_TEXTLINE', 'RIL_WORD', 'RIL_SYMBOL'))
...
ParagraphJustificationValues = structure(c(0L, 1L, 2L, 3L), .Names = c('JUSTIFICATION_UNKNOWN', 'JUSTIFICATION_LEFT', 'JUSTIFICATION_CENTER', 'JUSTIFICATION_RIGHT'))
...
`JUSTIFICATION_RIGHT` = GenericEnumValue('JUSTIFICATION_RIGHT', 3L, 'ParagraphJustification')
 ...
 setAs("character", "ParagraphJustification", function(from) asEnumValue(from, ParagraphJustificationValues, "ParagraphJustification", prefix = "JUSTIFICATION") )
...
OcrEngineModeValues = structure(c(0L, 1L, 2L, 3L), .Names = c('OEM_TESSERACT_ONLY', 'OEM_CUBE_ONLY', 'OEM_TESSERACT_CUBE_COMBINED', 'OEM_DEFAULT'))
